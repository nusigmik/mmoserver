...
public struct MessageRoot : IFlatbufferObject
{
  ...
  public static bool MessageRootBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "PTCS"); }
  ...
  public static void FinishMessageRootBuffer(FlatBufferBuilder builder, Offset<MessageRoot> offset) { builder.Finish(offset.Value, "PTCS"); }
};
