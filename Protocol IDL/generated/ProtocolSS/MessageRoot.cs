...
public struct MessageRoot : IFlatbufferObject
{
  ...
  public static bool MessageRootBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "PTSS"); }
  ...
  public bool MutateMessageType(MessageType message_type) { int o = __p.__offset(4); if (o != 0) { __p.bb.Put(o + __p.bb_pos, (byte)message_type); return true; } else { return false; } }
  ...
  public static void FinishMessageRootBuffer(FlatBufferBuilder builder, Offset<MessageRoot> offset) { builder.Finish(offset.Value, "PTSS"); }
};
